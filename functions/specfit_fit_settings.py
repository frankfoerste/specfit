...
##############################################################################
''' load in self programmed packages '''
##############################################################################


###############################################################################
class specfit_fit_settings(QtWidgets.QWidget):
    def __init__(self, parent = None, _parent = None):
        ### initalize main window ###
        super(specfit_fit_settings, self).__init__(parent)
        self.parent = _parent
        ...
        self.standard_style_sheet = 'QWidget {background-color:white; font-size: 10px} '\
        ...
        # self.colors = list(col.CSS4_COLORS.values())                         ### list of colors used for plotting
        self.__init__UI()
    ...
    def __init__UI(self):
        ...
        self.check_PU_Lines.setCheckState(0)
        self.check_Escape_Lines.setCheckState(0)
        self.check_batch_fitting.setCheckState(0)
        self.check_save_background.setCheckState(0)
        self.check_save_fitted_spectrum.setCheckState(0)
        self.check_save_fitted_spectrum.setCheckState(0)
    ...
    def __init_connections(self, ):
        ...
        self.check_calc_minima.stateChanged.connect(lambda state: self.parent.check_calc_minima.setChecked(state == QtCore.Qt.Checked))
...
#####################################################
# end of code associated with specfit fit  settings #      
#####################################################
