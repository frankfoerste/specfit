...
if __name__ == '__main__':
    folder = '/home/frank/Doktorarbeit/XRay Scientific/Git/KI-RFA-Sensor/Machine Learning/project/data/xps_fp2_simulations/Cu_alloy_0_Batch_SimSptSummary.csv'
    spec, para = csv2spec_para(folder)
    tensor = csv_tensor_positions(folder)
    fig = plt.figure('test')
    fig.clf()
    ax = fig.subplots()
    ax.plot(spec[0])
