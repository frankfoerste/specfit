...
class SpecFit(object):
    ...
    def addLines(self, Z_and_Lines):
        ...
        for element in Z_and_Lines:
            ...
            for line in Z_and_Lines[element][1]:
                entry = [Z_and_Lines[element][2]]  #'e.g. L1'
    ...
    def get_xraylib_lineset(self, lineset):
        """
        getlineset of line #[Ka_Lines, Kb_Lines, K_Lines, L1_Lines, L2_Lines, L3_Lines, L_Lines]
        """
    ...
    def fit(self, minchange=None , full=True):
        ...
        while np.abs((oldresid - resid_std)/oldresid) > minchange:
            ...
            print(f"{iteration}. fit iteration, residchange = {(oldresid - resid_std) / oldresid}")
